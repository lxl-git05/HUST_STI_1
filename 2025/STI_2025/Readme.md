...
| :----: | :------: | :------------------------: |
|  PC13  |   LED0   |          板载LED           |
|  PB8   | OLED_SCL | 第一次PCB接反了,第二版无误 |
|  PB9   | OLED_SDA | 第一次PCB接反了,第二版无误 |
|  PB12  |   KEY1   |           按键1            |
|  PB13  |   KEY2   |           按键2            |
...
|  PA2   | USART2_TX |                       |
|  PA3   | USART2_RX |                       |
|  PB10  | USART3_TX | 在11.13确定去掉该串口 |
|  PB11  | USART3_RX | 在11.13确定去掉该串口 |
...
|        |             | 备注:这里的软件IIC在11.13全部改为硬件IIC,如下 |
|  PB6   |   Y8_SCL    |               修改后的硬件IIC1                |
|  PB7   |   Y8_SDA    |               修改后的硬件IIC1                |
|  PB10  | MPU6050_SCL |               修改后的硬件IIC2                |
|  PB11  | MPU6050_SDA |               修改后的硬件IIC2                |
|        |             |                                               |
|  PA15  |   Buzzer    |                    蜂鸣器                     |
|  PB3   |    LED1     |                  光亮显示用                   |
