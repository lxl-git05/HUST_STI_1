...
void Motor_PID_Check(void)						// 调试任务:电机PID检查
{
	...
	// VOFA展示PID调参
	// 单独展示
//		printf("%f,%f,%f,%f,%f,%f\n",Motor_A.GoalSpeed * Motor_A.DIR, Motor_A.RealSpeed * Motor_A.DIR , Motor_A.SetSpeed,Motor_A.PID_s.pout,Motor_A.PID_s.iout,Motor_A.PID_s.dout);
//		printf("%f,%f,%f,%f,%f,%f\n",Motor_B.GoalSpeed , Motor_B.RealSpeed , Motor_B.SetSpeed,Motor_B.PID_s.pout,Motor_B.PID_s.iout,Motor_B.PID_s.dout);
	// 联调
	printf("%f,%f,%f,%f,%f,%f\n",Motor_A.GoalSpeed * Motor_A.DIR, Motor_A.RealSpeed * Motor_A.DIR , Motor_A.SetSpeed,Motor_B.GoalSpeed , Motor_B.RealSpeed * Motor_B.DIR , Motor_B.SetSpeed);
}
