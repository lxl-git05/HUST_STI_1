...
#define ACCEL_FS_2G        	(0x00 << 5)    // ±2g
#define ACCEL_FS_4G        	(0x01 << 5)    // ±4g
#define ACCEL_FS_8G        	(0x02 << 5)    // ±8g
#define ACCEL_FS_16G       	(0x03 << 5)    // ±16g

// 陀螺仪量程对应寄存器值 (GYRO_CONFIG0[7:5])
#define GYRO_FS_250        	(0x00 << 5)    // ±250°/s
#define GYRO_FS_500        	(0x01 << 5)    // ±500°/s
#define GYRO_FS_1000       	(0x02 << 5)    // ±1000°/s
#define GYRO_FS_2000       	(0x03 << 5)    // ±2000°/s
