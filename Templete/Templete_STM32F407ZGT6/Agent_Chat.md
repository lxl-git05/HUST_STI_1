...
+ 首先你阅读比赛说明书，明确寻迹和球平衡解耦，现在我开始进行寻迹的单独优化，首先寻迹包含basespeed和偏移speed，也就是PID计算出来的两轮差速，我需要实现的是巡线+加速度尽量小，那么起始速度和停止速度需要尽量小，也就是base，同时小车左右摇晃也需要尽量小，现在开始协助我从简单巡线直到达到前面讲的目标，后续提到寻迹你都可以以此为目标，现在进行记忆
